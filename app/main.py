...
ai_Tupac = aitextgen(to_gpu=False, model_folder='/projects/00817c4c-2234-4da4-8978-4e3c95b77bdd/nlp-writer-scaffold-main/app/trained_model/Tupac_Model')
ai_Eminem = aitextgen(to_gpu=False, model_folder='/projects/00817c4c-2234-4da4-8978-4e3c95b77bdd/nlp-writer-scaffold-main/app/trained_model/Eminem_Model')
ai_TTC = aitextgen(to_gpu=False, model_folder='/projects/00817c4c-2234-4da4-8978-4e3c95b77bdd/nlp-writer-scaffold-main/app/trained_model/TtC_Model')
...
# #--------------Eminem--------------------
@app.route(base_url + '/generate_text_eminem', methods=["POST"])
...
# #--------------TTC--------------------
@app.route(base_url + '/generate_text_ttc', methods=["POST"])
